		...
		<el-form :inline="true" :model="formInline" class="demo-form-inline">
			<el-form-item v-if="isShow.indexOf('房源')!=-1">
				<el-select v-model="value" placeholder="房源">
					<el-option v-for="compact1 in compact" :key="compact1.value" :label="compact1.label" :value="compact1.value">
					</el-option>
				</el-select>
			</el-form-item>
			...
			<el-form-item v-if="isShow.indexOf('时间')!=-1">
				<!-- <div class="block"> -->
				<el-date-picker class="searchData" v-model="data" type="daterange" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期">
				</el-date-picker>
				<!-- </div> -->
			</el-form-item>
			...
			<el-form-item v-if="isShow.indexOf('城市')!=-1">
				<el-select v-model="cityVal" placeholder="城市">
					<el-option v-for="city1 in city" :key="city1.value" :label="city1.label" :value="city1.value">
					</el-option>
				</el-select>
			</el-form-item>
			...
			<el-form-item v-if="isShow.indexOf('小区')!=-1">
				<el-select v-model="communityVal" placeholder="小区">
					<el-option v-for="community1 in community" :key="community1.value" :label="community1.label" :value="community1.value">
					</el-option>
				</el-select>
			</el-form-item>
			...
			<el-form-item v-if="isShow.indexOf('归属')!=-1">
				<el-cascader placeholder="房源归属" :options="cascader" v-model="selectedOptions" @change="handleChange">
				</el-cascader>
			</el-form-item>
