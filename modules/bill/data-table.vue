            ...
            <el-table-column
                ...
                <template slot-scope="scope">
                    <div slot="reference" class="name-wrapper">
                        <span size="medium">{{ scope.row.name }}<i class="el-icon-phone"></i></span>
                ...
                <template slot-scope="scope">
                    <el-dropdown>
                        <el-button
                                type="primary"
                                size="mini"
                                @click.native="handleReceive(scope.$index, scope.row)">
                            收款<i class="el-icon-arrow-down el-icon--right"></i>
                        </el-button>
