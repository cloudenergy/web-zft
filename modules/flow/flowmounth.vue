  ...
  <div>
      <div class="block" style="margin-bottom:10px">
        <el-form :inline="true" :model="formInline" class="demo-form-inline  flexc flexce" size="mini">   
          ...
          <span class="marsp marspa ">年份</span>
          <el-form-item label="" style="margin:0">
            <el-select v-model="formInline.community" placeholder="年份" class="minisel">
          ...
          <el-form-item label="" style="margin:0">
            <el-select v-model="formInline.community" placeholder="流水来源" class="minisel">
