	...
	<div class="housing">
		<el-tabs v-model="activeName">
			<el-tab-pane label="整租" name="wholeRent">
				<el-form ref="wholeRent">
					...
					<el-form-item v-for="(value,key) in wholeRent" :label="transition(key)" :key="value.id">
						<ul class="formUl">
							<li v-for="(v,i) in value" :key="v.id">
			...
			<el-tab-pane label="合租" name="jointRent">
				<el-form ref="jointRent">
					...
					<el-form-item v-for="(value,key) in jointRent" :label="transition(key)" :key="value.id">
						<ul class="formUl">
							<li v-for="(v,i) in value" :key="v.id">
								<el-checkbox :label="v"></el-checkbox>
								<i class="el-icon-delete" @click="alertMsg(value,i)"></i>
			...
			<el-tab-pane label="独栋" name="third">
				<el-form ref="detached">
					...
					<el-form-item v-for="(value,key) in detached" :label="transition(key)" :key="value.id">
						<ul class="formUl">
							<li v-for="(v,i) in value" :key="v.id">
								<el-checkbox :label="v"></el-checkbox>
								<i class="el-icon-delete" @click="alertMsg(value,i)"></i>
			...
			<div class="addDiv">
				...
				<el-col :span="16">
					<el-select v-model="addSelect" placeholder="请选择" class="addSelect">
						<el-option v-for="(val,key) in wholeRent" :key="val.id" :label="transition(key)" :value='key'></el-option>
					</el-select>
				</el-col>
			</div>
		...
		<el-dialog title="提示" :visible.sync="hzdialogVisible" width="30%">
			...
			<div class="addDiv">
				...
				<el-col :span="16">
					<el-select v-model="addSelect" placeholder="请选择" class="addSelect">
						<el-option v-for="(val,key) in jointRent" :key="val.id" :label="transition(key)" :value='key'></el-option>
					</el-select>
				</el-col>
			</div>
		...
		<el-dialog title="提示" :visible.sync="dddialogVisible" width="30%">
			...
			<div class="addDiv">
				...
				<el-col :span="16">
					<el-select v-model="addSelect" placeholder="请选择" class="addSelect">
						<el-option v-for="(val,key) in detached" :key="val.id" :label="transition(key)" :value='key'></el-option>
					</el-select>
				</el-col>
			</div>
