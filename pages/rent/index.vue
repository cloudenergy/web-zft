<template>
	<el-container>
		...
		<el-container>
			...
			<div class="result">
				<DataTable v-if="housesRent" :housesrentData='housesRent' class="rentTable" v-loading="!housesRent" @refresh="refresh" @pageSize="pageSize" @rentWithout='query' @paymFresh="query()"/>
			</div>
		</el-container>
	</el-container>
</template>
